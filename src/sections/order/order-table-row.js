...
export default function OrderTableRow({
  ...
  const { details, orders_status, order_no, order_date, user, total_price } =
    row;
    console.log(row);
    const {t}=useLocales()
