...
export default function OrderListView() {
  ...
  // (allFoodOrdersDelivery, ordersLoading)
            ...
            {STATUS_OPTIONS.map((tab) => (
              <Tab
                ...
                icon={
                  ...
                  >
                    {tab.value === "all" && allFoodOrdersDelivery.length}
                    {tab.value === DELIVERY_STATUS_OPTIONS.DONE &&
                      allFoodOrdersDelivery.filter(
                        (order) =>
                    ...
                    {tab.value === DELIVERY_STATUS_OPTIONS.PROCESSING &&
                      allFoodOrdersDelivery.filter(
                        (order) =>
                          order.orders_status.name ===
                          DELIVERY_STATUS_OPTIONS.PROCESSING
                      ).length}
                    {tab.value === DELIVERY_STATUS_OPTIONS.READY &&
                      allFoodOrdersDelivery.filter(
                        (order) =>
                          order.orders_status.name ===
                          DELIVERY_STATUS_OPTIONS.READY
                      ).length}
                  </Label>
                }
              />
